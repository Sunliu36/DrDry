...
String uuid = "";
StaticJsonDocument<800> json_doc1 = StaticJsonDocument<800>();
StaticJsonDocument<800> json_doc2 = StaticJsonDocument<800>();
StaticJsonDocument<3000> json_transmit_doc = StaticJsonDocument<3000>();
DeserializationError json_error;
char json_output1[800] = {0};
char json_output2[800] = {0};
char json_transmit_output[3000] = {0};
char doc_output[3000] = {0};
HTTPClient http;
...
void loop() {
    ...
    clearContent(json_output1, 800);

    // 土壤
    int soil_1_value = analogRead(soil_1);
    int soil_2_value = analogRead(soil_2);
    
    json_doc1 = StaticJsonDocument<800>();
    json_transmit_doc = StaticJsonDocument<3000>();

    char buffer[800] = {0};
    clearContent(buffer, 800);
    ...
    sprintf(buffer, "%.2lf", soil_1_value);
